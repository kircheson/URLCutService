 ...
 */
final class Version20241002073046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE url CHANGE url url VARCHAR(255) NOT NULL, CHANGE hash hash VARCHAR(14) NOT NULL, CHANGE created_date created_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
